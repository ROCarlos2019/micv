...
const ItemSliding = class {
  ...
  connectedCallback() {
    ...
    return (0,C_Users_rcpineda_Desktop_iOnic_Angular_mi_cv_app_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
       ...
       */
      _this2.mutationObserver = (0,_watch_options_Dtdm8lKC_js__WEBPACK_IMPORTED_MODULE_5__.w)(el, 'ion-item-option', /*#__PURE__*/(0,C_Users_rcpineda_Desktop_iOnic_Angular_mi_cv_app_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  updateOptions() {
    ...
    return (0,C_Users_rcpineda_Desktop_iOnic_Angular_mi_cv_app_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      for (let i = 0; i < options.length; i++) {
        ...
        const side = (0,_helpers_1O4D2b7y_js__WEBPACK_IMPORTED_MODULE_3__.o)(option.side) ? 'end' : 'start';
        if (side === 'start') {
...
//# sourceMappingURL=6492.3a1e17ff479180a3.js.map