...
const FabButton = class {
  constructor(hostRef) {
     ...
     * fab list.
     */
    this.closeIcon = _index_BLV6ykCk_js__WEBPACK_IMPORTED_MODULE_4__.t;
    this.onFocus = () => {
      this.ionFocus.emit();
    };
    this.onBlur = () => {
  ...
  render() {
    ...
    return (0,_index_B_U9CtaY_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_B_U9CtaY_js__WEBPACK_IMPORTED_MODULE_1__.j, {
      ...
      onBlur: this.onBlur,
      onClick: ev => (0,_theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_3__.o)(href, ev, this.routerDirection, this.routerAnimation)
    }, inheritedAttributes), (0,_index_B_U9CtaY_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-icon", {
...
//# sourceMappingURL=5458.32188824104256a3.js.map