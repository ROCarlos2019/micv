...
const Card = class {
  ...
  componentWillLoad() {
    this.inheritedAriaAttributes = (0,_helpers_1O4D2b7y_js__WEBPACK_IMPORTED_MODULE_1__.b)(this.el, ['aria-label']);
  }
  isClickable() {
  ...
  renderCard(mode) {
    ...
    if (!clickable) {
      return [(0,_index_B_U9CtaY_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null)];
    }
    const {
      href,
      routerAnimation,
    ...
    return (0,_index_B_U9CtaY_js__WEBPACK_IMPORTED_MODULE_0__.h)(TagType, Object.assign({}, attrs, inheritedAriaAttributes, {
      class: "card-native",
      part: "native",
      disabled: this.disabled,
      onClick: ev => (0,_theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_2__.o)(href, ev, routerDirection, routerAnimation)
    }), (0,_index_B_U9CtaY_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null), clickable && mode === 'md' && (0,_index_B_U9CtaY_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-ripple-effect", null));
  }
  render() {
...
//# sourceMappingURL=8759.617b07b3e25d1a66.js.map